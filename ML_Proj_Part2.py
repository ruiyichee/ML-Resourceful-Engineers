...
def get_data(data):
	raw_data = open(data, "r+", encoding="utf-8")	# r+ is Special read and write mode, which is used to handle both actions when working with a file
	read = raw_data.read()
	print (read)

directory1 = "C:/Users/ruiyicx/Documents/SUTD Subjects/ESD Term 7/01.112 Machine Learning/Project/CN/CN/dev.in"
