...
transition_params_CN = transition_params(dirCN_train)
viterbi_algo(dirCN_in, transition_params_CN, emission_param_CN, tag_count_CN)
print("CN DONE")
...
viterbi_algo(dirES_in, transition_params_ES, emission_param_ES, tag_count_ES)
print("ES DONE")
...
viterbi_algo(dirRU_in, transition_params_RU, emission_param_RU, tag_count_RU)
print("RU DONE")